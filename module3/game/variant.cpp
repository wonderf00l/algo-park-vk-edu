...
void proceed_astar(std::unordered_map<GameState, std::pair<GameState, char>, GameState::HashFunc> &visited,
                   std::set<GameState, GameState::Comparator> &pq, GameState &current_state, GameState next_state,
                   char step) {
...
bool GameState::operator!=(const GameState &game_state) const { return !(*this == game_state); }

bool GameState::can_move_up() const { return empty_cell_position > 3; }

bool GameState::can_move_down() const { return empty_cell_position < 12; }

bool GameState::can_move_left() const { return empty_cell_position % 4 != 0; }

bool GameState::can_move_right() const { return empty_cell_position % 4 != 3; }
