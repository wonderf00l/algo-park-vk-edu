...
int main() {
    ...
    kth_stat(arr, size, size * 0.1);
    std::cout << arr[(int)(size * 0.1)] << std::endl;
    kth_stat(arr, size, size * 0.5);
    std::cout << arr[(int)(size * 0.5)] << std::endl;
    kth_stat(arr, size, size * 0.9);
    std::cout << arr[(int)(size * 0.9)] << std::endl;
